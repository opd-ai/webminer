 ...
 * @build 2025-10-04T20:36:24.643Z
 */
/**
...
const PerformanceMonitor = {
  ...
  updateRecommendedThrottle() {
    let recommendedThrottle = 0.25;


    if (this.metrics.isMobile) {
    recommendedThrottle *= 0.6;
    }


    if (this.metrics.cpuCores <= 2) {
    recommendedThrottle *= 0.7;
    } else if (this.metrics.cpuCores >= 8) {
    recommendedThrottle *= 1.2;
    }
  ...
  triggerAdaptiveThrottling() {
    ...
    newThrottle = Math.min(currentThrottle, 0.10);
    } else if (this.stats.avgCpuUsage > 90) {
    newThrottle = currentThrottle * 0.8;
    } else if (this.stats.currentFrameRate < 20) {
    newThrottle = currentThrottle * 0.7;
    }
  ...
  checkBatteryThresholds() {
    ...
    const criticalBatteryThreshold = 0.10;
...
const MiningConsent = {
  ...
  updateIndicator(stats) {
    ...
    let healthIcon = '🟢';
    if (healthScore < 70) healthIcon = '🟡';
    if (healthScore < 40) healthIcon = '🔴';
...
const MobileOptimizer = {
  ...
  applyMobileSpecificSettings() {
    ...
    MiningConsent.state.throttleLevel = 0.15;
    MiningConsent.savePreference();
    }
...
startMining() {
  ...
  const targetInterval = 1000 / (60 * this.throttleLevel);
